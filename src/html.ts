...
<div class="middle"><section class="card plan-card"><div class="section-head"><div><h2 class="section-title">${escapeHtml(comparison.label)} against available plans</h2><div class="plan-subtitle"><strong>${fmtUsd(comparison.credits / 100)}</strong> · ${fmtCredits(comparison.credits)} credits</div></div></div><div class="plan-groups">${renderPlanGroups(summary, comparison.credits)}</div></section>
<section class="card source-card"><h2 class="section-title">Total usage by source</h2><div class="source-bars">${sources}</div></section></div>
<section class="card"><div class="section-head"><h2 class="section-title">Total model usage</h2></div><table><thead><tr><th>Model</th><th class="right">Calls</th><th class="right">Input</th><th class="right">Cache read</th><th class="right">Output</th><th class="right">Credits</th><th class="right">Share</th></tr></thead><tbody>${renderModelRows(summary)}</tbody></table></section>
