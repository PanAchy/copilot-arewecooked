...
export function renderHtml(summary: Summary): string {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Copilot AI Credit Usage Report</title><style>${REPORT_CSS}</style></head>
<body class="report-body"><main class="wrap">
<header class="top"><div><h1 class="title">Copilot AI Credit Usage Report</h1><div class="sub">${escapeHtml(reportRange(summary))}</div></div><a class="repo" href="https://github.com/PanAchy/copilot-arewecooked">Generated by copilot-arewecooked</a></header>
