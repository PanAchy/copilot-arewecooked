...
<div class="middle"><section class="card plan-card"><div class="section-head"><div><h2 class="section-title">Included credit comparison</h2><div class="plan-subtitle"><strong>${fmtUsd(comparison.credits / 100)}</strong> · ${fmtCredits(comparison.credits)} credits · ${escapeHtml(comparison.label.toLowerCase())}</div></div></div><div class="plan-groups">${renderPlanGroups(summary, comparison.credits)}</div></section>
<section class="card source-card"><h2 class="section-title">Usage by source</h2><div class="source-bars">${sources}</div></section></div>
