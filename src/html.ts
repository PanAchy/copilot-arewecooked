...
${warnings}<section class="card"><div class="section-head"><h2 class="section-title">Usage trend</h2><div class="head-meta">${fmtCredits(summary.totals.credits)} credits in range · ${comparison.label}: ${fmtCredits(comparison.credits)}</div></div><div class="chart">${renderTrend(trend)}</div></section>
